...
public class VariablesTest2 {
    ...
    public void startProcess() {
        ...
        // 设定负责人
        variables.put("assignee0", "张三2");
        variables.put("assignee1", "王经理2");
        variables.put("assignee2", "杨总经理2");
        variables.put("assignee3", "张财务2");
        // 4、启动流程
